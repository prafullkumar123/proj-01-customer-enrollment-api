...
@RestController
@RequestMapping("/v1")
public class EnrollmentController22 {
	
	public EnrollmentController22() {
	...
	private  Logger logger = Logger.getLogger(EnrollmentController22.class); 
	...
	public @ResponseBody EnrollmentResourceRes enroll(@RequestBody EnrollmentResourceReq enrollReq) throws EnrollmentReqInvalidException, SystemException, BusinessException, InterruptedException {

		logger.info("Entered into Resouce Layer :: "+enrollReq);

		EnrollmentResourceRes resourceResp = null;
		...
		resourceResp = respBuilder.buildResourceEnrollResp(enrollProcessRes, enrollReq);

		logger.info("Exit From Resouce Layer :: "+resourceResp);
